...
execute_process(COMMAND python setup.py build_ext
  "-I${NATIVE_INCLUDE_DIR}:${NATIVE_CACHE_INCLUDE_DIR}:${NATIVE_LOCAL_INCLUDE_DIR}"
  "-L${NATIVE_LIB_DIR}:${NATIVE_CACHE_LIB_DIR}:${NATIVE_LOCAL_LIB_DIR}"
  "-R${NATIVE_LIB_DIR}:${NATIVE_CACHE_LIB_DIR}:${NATIVE_LOCAL_LIB_DIR}"
