if(WIN32)
  ...
  if(WINDOWS_BUILD_CACHE)
    ...
    set(ENV{CMAKE_PROGRAM_PATH} "${WINDOWS_BUILD_CACHE}\\python\\scripts;$ENV{CMAKE_PROGRAM_PATH}")
  endif()
  ...
  file(GLOB python_dirs LIST_DIRECTORIES true
       "${BIOFORMATS_EP_BUILD_CACHE}/python/*/site-packages"
  ...
  if(BIOFORMATS_EP_BUILD_CACHE)
    ...
    set(ENV{CMAKE_PROGRAM_PATH} "${BIOFORMATS_EP_BUILD_CACHE}/bin:$ENV{CMAKE_PROGRAM_PATH}")
    if(APPLE)
